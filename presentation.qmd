...
* We looked at trends relating to ratings, age, and run time of different holiday movies 
  * We chose this data set because we are interested in:
    ...
    * changes in movie elements over time
    * if the holiday the movies were written for played a role in this
...
* Our second graph is a scatterplot with line of best fit showing the average rating over time for each holiday 
  ...
  * Fairly consistent
  * Kwanzaa movies have the shortest runtimes (but small sample size)
  * Hanukkah is next
  * Christmas has the longest with a concentration around 90 minutes
  * Holiday movies in general are typically around 90 minutes but have a wide range
  * Hard to tell a pattern in kwanzaa and hanukkah, but useful for christmas and holiday
:::
