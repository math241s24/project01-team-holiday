...
**Plan:** Within our dataset, we will be working with the following variables: primary_title- the most popular title the movie is known by, year- the year the movie was released, runtime_minutes- the length of the movie, christmas- whether or not the title contains "christmas" or some variation, hanukkah- whether or not the title contains "hanukkah" or some variation, kwanzaa- whether or not the title contains "kwanzaa" or some variation, holiday- whether or not the title contains "holiday", average_rating- ..., year-...
